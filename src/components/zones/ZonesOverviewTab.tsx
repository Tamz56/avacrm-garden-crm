                                    ...
                                    return (
                                        <React.Fragment key={zone.id}>
                                            <tr className="border-b border-slate-50 dark:border-white/10 hover:bg-slate-50/60 dark:hover:bg-white/5">
                                                ...
                                                <td className="px-4 py-2.5 text-right text-emerald-700 dark:text-emerald-400 font-semibold">
                                                ...
                                                <td className="px-4 py-2.5 text-right text-rose-500 dark:text-rose-400">
                                                ...
                                                <td className="px-4 py-2.5 text-right">
                                                    <div className="inline-flex items-center gap-1.5">
                                                        <button
                                                            type="button"
                                                            onClick={() => setSelectedZoneId(zone.id)}
                                                            className="inline-flex items-center justify-center px-2 h-8 rounded-lg border border-slate-200 dark:border-white/10 hover:bg-slate-100 dark:hover:bg-white/10 text-[11px] text-slate-700 dark:text-slate-300"
                                                            title="ดูรายละเอียด"
                                                        >
                                                            รายละเอียด
                                                        </button>
                                                        ...
                                                        <button
                                                            ...
                                                            className="inline-flex items-center justify-center w-8 h-8 rounded-lg border border-slate-200 dark:border-white/10 hover:bg-slate-100 dark:hover:bg-white/10"
                                                            title="แก้ไข"
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            className="inline-flex items-center justify-center w-8 h-8 rounded-lg border border-rose-200 dark:border-rose-500/30 hover:bg-rose-50 dark:hover:bg-rose-500/10"
                                                            title="ลบ"
                                                        >
