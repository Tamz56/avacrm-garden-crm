-- 137_update_view_dig_order_detail_add_tag_status.sql
-- Add t.status to view_dig_order_detail for workflow tracking
...
SELECT
    ...
    t.planting_position,
    t.note            AS tag_notes,
    t.status          AS tag_status,  -- NEW: for workflow tracking
    t.grade,                           -- NEW: for workflow display
...
GRANT SELECT ON public.view_dig_order_detail TO authenticated;
